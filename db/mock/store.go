...
// Source: /home/ccat/Repos/backend_masterclass/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -destination ./mock/store.go -package mockdb /home/ccat/Repos/backend_masterclass/db/sqlc Store
//
...
import (
	sqlc "backend-masterclass/db/sqlc"
	context "context"
	reflect "reflect"
...
// BlockSessionByID mocks base method.
func (m *MockStore) BlockSessionByID(ctx context.Context, id uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockSessionByID", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// BlockSessionByID indicates an expected call of BlockSessionByID.
func (mr *MockStoreMockRecorder) BlockSessionByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockSessionByID", reflect.TypeOf((*MockStore)(nil).BlockSessionByID), ctx, id)
}

// BlockSessionByUsername mocks base method.
func (m *MockStore) BlockSessionByUsername(ctx context.Context, username string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockSessionByUsername", ctx, username)
	ret0, _ := ret[0].(error)
	return ret0
}

// BlockSessionByUsername indicates an expected call of BlockSessionByUsername.
func (mr *MockStoreMockRecorder) BlockSessionByUsername(ctx, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockSessionByUsername", reflect.TypeOf((*MockStore)(nil).BlockSessionByUsername), ctx, username)
}

// CountBlockedSessions mocks base method.
func (m *MockStore) CountBlockedSessions(ctx context.Context) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountBlockedSessions", ctx)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountBlockedSessions indicates an expected call of CountBlockedSessions.
func (mr *MockStoreMockRecorder) CountBlockedSessions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountBlockedSessions", reflect.TypeOf((*MockStore)(nil).CountBlockedSessions), ctx)
}

// CountSessions mocks base method.
func (m *MockStore) CountSessions(ctx context.Context, username string) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountSessions", ctx, username)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) CountSessions(ctx, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountSessions", reflect.TypeOf((*MockStore)(nil).CountSessions), ctx, username)
}
...
// DeleteBlockedSessions mocks base method.
func (m *MockStore) DeleteBlockedSessions(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteBlockedSessions", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteBlockedSessions indicates an expected call of DeleteBlockedSessions.
func (mr *MockStoreMockRecorder) DeleteBlockedSessions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteBlockedSessions", reflect.TypeOf((*MockStore)(nil).DeleteBlockedSessions), ctx)
}
...
func (mr *MockStoreMockRecorder) DeleteSessionByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStore) DeleteSessionByUsername(ctx context.Context, username string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteSessionByUsername", ctx, username)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteSessionByUsername indicates an expected call of DeleteSessionByUsername.
func (mr *MockStoreMockRecorder) DeleteSessionByUsername(ctx, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSessionByUsername", reflect.TypeOf((*MockStore)(nil).DeleteSessionByUsername), ctx, username)
}
...
func (m *MockStore) GetAccountEntries(ctx context.Context, accountID int64) ([]sqlc.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountEntries", ctx, accountID)
	ret0, _ := ret[0].([]sqlc.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAccountEntries(ctx, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountEntries", reflect.TypeOf((*MockStore)(nil).GetAccountEntries), ctx, accountID)
}
...
func (m *MockStore) GetSessionByID(ctx context.Context, id uuid.UUID) (sqlc.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetSessionByUsername(ctx context.Context, username string) (sqlc.Session, error) {
	m.ctrl.T.Helper()
...
// GetTransfersFrom mocks base method.
func (m *MockStore) GetTransfersFrom(ctx context.Context, fromAccountID int64) ([]sqlc.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersFrom", ctx, fromAccountID)
	ret0, _ := ret[0].([]sqlc.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersFrom indicates an expected call of GetTransfersFrom.
func (mr *MockStoreMockRecorder) GetTransfersFrom(ctx, fromAccountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersFrom", reflect.TypeOf((*MockStore)(nil).GetTransfersFrom), ctx, fromAccountID)
}

// GetTransfersTo mocks base method.
func (m *MockStore) GetTransfersTo(ctx context.Context, toAccountID int64) ([]sqlc.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersTo", ctx, toAccountID)
	ret0, _ := ret[0].([]sqlc.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersTo indicates an expected call of GetTransfersTo.
func (mr *MockStoreMockRecorder) GetTransfersTo(ctx, toAccountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersTo", reflect.TypeOf((*MockStore)(nil).GetTransfersTo), ctx, toAccountID)
}
...
// ListBlockedSessions mocks base method.
func (m *MockStore) ListBlockedSessions(ctx context.Context, arg sqlc.ListBlockedSessionsParams) ([]sqlc.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListBlockedSessions", ctx, arg)
	ret0, _ := ret[0].([]sqlc.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListBlockedSessions indicates an expected call of ListBlockedSessions.
func (mr *MockStoreMockRecorder) ListBlockedSessions(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBlockedSessions", reflect.TypeOf((*MockStore)(nil).ListBlockedSessions), ctx, arg)
}
...
func (m *MockStore) ListSessions(ctx context.Context, arg sqlc.ListSessionsParams) ([]sqlc.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListSessions(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSessions", reflect.TypeOf((*MockStore)(nil).ListSessions), ctx, arg)
}
...
// UnblockSessionByID mocks base method.
func (m *MockStore) UnblockSessionByID(ctx context.Context, id uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnblockSessionByID", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// UnblockSessionByID indicates an expected call of UnblockSessionByID.
func (mr *MockStoreMockRecorder) UnblockSessionByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnblockSessionByID", reflect.TypeOf((*MockStore)(nil).UnblockSessionByID), ctx, id)
}

// UnblockSessionByUsername mocks base method.
func (m *MockStore) UnblockSessionByUsername(ctx context.Context, username string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnblockSessionByUsername", ctx, username)
	ret0, _ := ret[0].(error)
	return ret0
}

// UnblockSessionByUsername indicates an expected call of UnblockSessionByUsername.
func (mr *MockStoreMockRecorder) UnblockSessionByUsername(ctx, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnblockSessionByUsername", reflect.TypeOf((*MockStore)(nil).UnblockSessionByUsername), ctx, username)
}
...
// UpdateEntryByAccount mocks base method.
func (m *MockStore) UpdateEntryByAccount(ctx context.Context, arg sqlc.UpdateEntryByAccountParams) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEntryByAccount", ctx, arg)
	ret0, _ := ret[0].(sqlc.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateEntryByAccount indicates an expected call of UpdateEntryByAccount.
func (mr *MockStoreMockRecorder) UpdateEntryByAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEntryByAccount", reflect.TypeOf((*MockStore)(nil).UpdateEntryByAccount), ctx, arg)
}

// UpdateSessionByID mocks base method.
func (m *MockStore) UpdateSessionByID(ctx context.Context, arg sqlc.UpdateSessionByIDParams) (sqlc.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSessionByID", ctx, arg)
	ret0, _ := ret[0].(sqlc.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateSessionByID indicates an expected call of UpdateSessionByID.
func (mr *MockStoreMockRecorder) UpdateSessionByID(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateSessionByID", reflect.TypeOf((*MockStore)(nil).UpdateSessionByID), ctx, arg)
}

// UpdateSessionByUsername mocks base method.
func (m *MockStore) UpdateSessionByUsername(ctx context.Context, arg sqlc.UpdateSessionByUsernameParams) (sqlc.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSessionByUsername", ctx, arg)
	ret0, _ := ret[0].(sqlc.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateSessionByUsername indicates an expected call of UpdateSessionByUsername.
func (mr *MockStoreMockRecorder) UpdateSessionByUsername(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateSessionByUsername", reflect.TypeOf((*MockStore)(nil).UpdateSessionByUsername), ctx, arg)
}
